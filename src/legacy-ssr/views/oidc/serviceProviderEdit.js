import { escapeHtml, renderFlash, renderIconBtn, renderLayout, renderPageHeader } from "../common/layout.js";
...
export function renderServiceProviderEditPage({ serviceProvider, flash, form = {}, ezAccessEnvironments = [] } = {}) {
  ...
  const body = `
    ...
    ${renderPageHeader({
      ...
      actions: renderIconBtn({ icon: "return", label: "Back to list", href: "/legacy/oidc/service-providers", variant: "neutral", showLabel: true })
    })}
    ...
    <section class="card">
      <div class="card__body">
        ...
        <form class="sp-form" method="post" action="/legacy/oidc/service-providers/${encodeURIComponent(serviceProvider.id)}" novalidate>
          ${renderField({
            label: "Name",
            name: "name",
            value: values.name,
          ...
          <div class="sp-form__actions">
            ...
            ${renderIconBtn({ icon: "return", label: "Cancel", href: "/legacy/oidc/service-providers", variant: "neutral", showLabel: true })}
          </div>
        </form>

        <form class="sp-form__delete" method="post" action="/legacy/oidc/service-providers/${encodeURIComponent(serviceProvider.id)}/delete" data-confirm="Delete this Service Provider?">
