...
export function renderSamlServiceProviderEditPage({ serviceProvider, flash, form = {}, ezAccessEnvironments = [], acsUrl = "" } = {}) {
  ...
  const body = `
    ...
    ${renderPageHeader({
      ...
      actions: renderIconBtn({ icon: "return", label: "Back to list", href: "/legacy/saml/service-providers", variant: "neutral", showLabel: true })
    })}
    ...
    <section class="card">
      <div class="card__body">
        ...
        <form class="sp-form" method="post" action="/legacy/saml/service-providers/${encodeURIComponent(sp.id)}" novalidate>
          ...
          <div class="sp-form__actions">
            ...
            ${renderIconBtn({ icon: "return", label: "Cancel", href: "/legacy/saml/service-providers", variant: "neutral", showLabel: true })}
          </div>
        </form>
