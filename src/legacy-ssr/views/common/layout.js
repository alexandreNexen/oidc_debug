...
function renderTopbar(activeNav) {
  const navItems = [
    { id: "dashboard", label: "Dashboard", href: "/legacy" },
    { id: "service-providers", label: "OIDC", href: "/legacy/oidc/service-providers" },
    { id: "saml-service-providers", label: "SAML", href: "/legacy/saml/service-providers" }
  ];
    ...
    <header class="topbar">
      <div class="topbar__inner">
        <div class="topbar__brand">
          <img class="topbar__logo" src="/legacy/assets/brand/logo.svg" alt="Logo Eiffage" />
        </div>
...
export function renderIconBtn({ icon, label, href, type = "button", variant = "neutral", showLabel = false, attr = "" }) {
  ...
  const img = `<img src="/legacy/assets/icons/${escapeHtml(icon)}.svg" width="16" height="16" alt="" aria-hidden="true">`;
  if (href) {
...
<html lang="fr">
  <head>
    ...
    <link rel="stylesheet" href="/legacy/assets/app.css" />
  </head>
  <body class="page">
    ...
    <script src="/legacy/assets/app.js" defer></script>
  </body>
</html>`;
}
